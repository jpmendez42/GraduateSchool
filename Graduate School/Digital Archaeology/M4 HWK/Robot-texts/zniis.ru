...
#Запрет старых страниц
Disallow: /blog/            # Ссылки с метками openstat
Disallow: /wp-content/uploads/2013/ #Закрываем файлы из 2013 года
Disallow: /wp-content/uploads/2014/ #Закрываем файлы из 2014 года
Disallow: /wp-content/uploads/2015/ #Закрываем файлы из 2015 года
Disallow: /wp-content/uploads/2016/ #Закрываем файлы из 2016 года
Disallow: /wp-content/uploads/2017/ #Закрываем файлы из 2017 года
Disallow: /wp-content/uploads/2018/ #Закрываем файлы из 2018 года
Disallow: /wp-content/uploads/2019/ #Закрываем файлы из 2019 года
Disallow: /wp-content/uploads/2020/ #Закрываем файлы из 2020 года
Disallow: /wp-content/uploads/2024/09/YUbilej-NII-Radio.mp3 #Закрываем песню 1
Disallow: /wp-content/uploads/2024/09/YUbilej-NII-Radio-dinamichnaya-versiya.mp3 #Закрываем песню 2
Disallow: /proekty/proizvodstvo/rfid/ #Закрываем РФИД
Disallow: /05700-home/ #Закрываем странный черновик главной из 2020
Disallow: /wp-content/uploads/wp-import-export-lite/ #WP Import Export Rule
Disallow: /bdpn/check? #Закрываем странные страницы после проверки номеров через БДПН
Disallow: /press.cent/news/? #Закрываем странные страницы типа ?_page=29
Disallow: /*page= #Закрываем странные страницы типа ?_page=29
Disallow: /*switch= #Закрываем странные страницы типа ?_page=29



# Одина или несколько ссылок на карту сайта (файл Sitemap). Это независимая
# директива и дублировать её для каждого User-agent не нужно.
Sitemap: https://www.nic-t.ru/sitemap.xml
