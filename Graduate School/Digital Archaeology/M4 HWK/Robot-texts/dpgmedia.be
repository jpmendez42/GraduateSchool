...
<head>
    ...
    <script type="text/javascript">
        const callbackUrl = new URL(decodeURIComponent('https%3A%2F%2Fwww.dpgmediagroup.com%2Fprivacygate-confirm%3FredirectUri%3D%252Fnl-BE%26authId%3D7ba7db50-2841-44e9-b688-71b6a6541e3c'))
        window._privacy = window._privacy || [];
        window.cmpProperties = {
            integratorId: 'dpgmediagroup',
            language: 'nl',
    ...
    <style>
        ...
        .container {
            ...
            background-image: url("https://myprivacy-static.dpgmedia.net/consent/resources/backgrounds/dpgmediagroup.webp");
            width: 100vw;
            height: 100vh;
        ...
        @media only screen and (max-width: 768px) {
            .container {
                /*noinspection CssUnknownTarget*/
                background-image: url("https://myprivacy-static.dpgmedia.net/consent/resources/backgrounds/medium/dpgmediagroup.webp");
            }
        }
        ...
        @media only screen and (max-width: 600px) {
            .container {
                /*noinspection CssUnknownTarget*/
                background-image: url("https://myprivacy-static.dpgmedia.net/consent/resources/backgrounds/small/dpgmediagroup.webp");
            }
        }
