...
User-agent: Foobot
User-agent: FreeFind
User-agent: FreeWebMonitoring SiteChecker/0.1
User-agent: FrontPage
User-agent: FrontPage [NC,OR]
User-agent: FurlBot
User-agent: Gaisbot
User-agent: Gaisbot/3.0
User-agent: GetBot
User-agent: GetRight
...
User-agent: InternetSupervision
User-agent: IRLbot
User-agent: Iron
...
User-agent: LinksManager
User-agent: LinksManager.com_bot
...
User-agent: Nutch
User-agent: Nutch*
User-agent: NutchCVS/0.06-dev
User-agent: NutchCVS/0.7.1
User-agent: NutchOrg
User-agent: oBot
User-agent: Ocelli
User-agent: Octopus
...
User-agent: QueryN.Metasearch
User-agent: radian6 comment reader
User-agent: radian6 Feedfetcher
...
User-agent: whitevector crawler
User-agent: Whitevector+Crawler
User-agent: Widow
...
Sitemap: https://www.forum2x2.ru/sitemap.xml
