...
Disallow: *?reroll=         # рандом
Disallow: *?preview=        # предпросмотр
Disallow: *?restart=        # предпросмотр
Disallow: *?PROPOSE=        # предпросмотр
...
Disallow: /local/cron/
Disallow: /vendor/
Disallow: /editor/new_test/success.php
Disallow: /editor/new_stand_test/success.php
Disallow: *?ei=
Disallow: *?p=
Disallow: *?q=
Disallow: *?search=
...
Allow: /local/*.png
Allow: /local/*.gif
Sitemap: https://pikuco.ru/sitemap-index.xml
