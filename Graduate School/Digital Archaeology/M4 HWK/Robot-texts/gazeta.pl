#Zastrzezenie prawnoautorskie

#Wersja polska:
#Wlasciciel niniejszego serwisu nie wyraza zgody na zwielokrotnianie ani inne korzystanie z utworow rozpowszechnionych w tym serwisie, w celu eksploracji tekstow i danych.
#Wiecej informacji w zastrzezeniu dot. eksploracji tekstow i danych pod adresem: agora.pl/zastrzezenie-prawne

#Wersja angielska: 
#The owner of this website, does not authorize reproduction or other use of copyrighted works distributed on this website for the purpose of exploring of texts and data.
#More information can be found in Reservation on text and data mining at agora.pl/en/copyright-reservation

#Koniec zastrzezenia prawnoautorskiego
...
Disallow: /75224259/
Disallow: /0,0.html?mtpromo
Disallow: /0,0.html?foryou
Disallow: /0,0.html?mtpromo*
Disallow: /0,0.html?foryou*
Disallow: /*_gl
...
User-agent: Feedpresso Content Index Bot
Disallow: /
...
User-agent: http://linkfluence.com
Disallow: /

User-agent: http://mediacloud.org
Disallow: /
...
User-agent: https://developers.snap.com/robots
Disallow: /

User-agent: https://help.qwant.com/bot/
Disallow: /
...
User-agent: http://www.trendiction.de/bot
Disallow: /
