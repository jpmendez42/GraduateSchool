User-Agent: *
Allow: /
Disallow: /feed/boost_feed
Disallow: /search
Disallow: /search/*q=*

Sitemap: https://www.oudersvannu.nl/sitemap.xml
...
# Zie ook de Gebruikersvoorwaarden van DPG Media B.V. op www.dpgmedia.nl Gebruiksvoorwaarden - DPG Media
# 
...
# automated method).
# See also the terms of use of DPG Media B.V. at www.dpgmedia.nl Gebruiksvoorwaarden - DPG Media
